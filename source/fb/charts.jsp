    ...
    <tr>
        ...
        <%if (!Pagez.getUserSession().getIsfacebook()){%>
            <td valign="top" width="315" rowspan="2">
                <font class="mediumfont">Embed this Chart</font>
                <br/>
                <font class="normalfont" style="font-weight:bold;">into a blog/website</font>
                <br/>
                ...
                <div id="toggleTextSmall" style="display: none;">
                            ...
                            <%=FlashChartWidget.getEmbedCode(chart, Pagez.getUserSession().getUser(), 200, 175)%>
                            </textarea>
                            ...
                            var pconfsmall={
                              ...
                              defaultBookmarkURL: '<%=FlashChartWidget.getBookmark(chart, Pagez.getUserSession().getUser())%>',
                ...
                <div id="toggleTextMedium" style="display: block">
