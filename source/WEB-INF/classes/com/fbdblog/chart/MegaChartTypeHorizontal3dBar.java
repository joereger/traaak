...
public class MegaChartTypeHorizontal3dBar implements MegaChartType{
    ...
    public JFreeChart getJFreeChart(MegaChart megaChart) {
        ...
        //Create the chart
        return ChartFactory.createBarChart3D(megaChart.getChart().getName(), megaChart.getxAxisTitle(), megaChart.getyAxisTitle(), dataset, PlotOrientation.HORIZONTAL, true, false, false);
    }
    ...
    public String chartDataAsJSON(MegaChart megaChart){
        return ChartDataAsJSON.horizontalBar(megaChart);
    }
