...
public class MegaChartTypeStackedBar3d implements MegaChartType{
    ...
    public JFreeChart getJFreeChart(MegaChart megaChart) {
        ...
        //Create the chart
        return ChartFactory.createStackedBarChart3D(megaChart.getChart().getName(), megaChart.getxAxisTitle(), megaChart.getyAxisTitle(), dataset, PlotOrientation.VERTICAL, true, false, false);
    }
    ...
    public String chartDataAsJSON(MegaChart megaChart){
        return ChartDataAsJSON.stackedBarChart(megaChart);
    }
