...
public class MegaChartTypeStackedBar implements MegaChartType{
    ...
    public JFreeChart getJFreeChart(MegaChart megaChart) {
        ...
        //Create the chart
        return ChartFactory.createStackedBarChart(megaChart.getChart().getName(), megaChart.getxAxisTitle(), megaChart.getyAxisTitle(), dataset, PlotOrientation.VERTICAL, true, false, false);
    }
