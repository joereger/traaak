...
public class MegaChartType3DBar implements MegaChartType{
    ...
    public JFreeChart getJFreeChart(MegaChart megaChart) {
        ...
        //Create the chart
        return ChartFactory.createBarChart3D(megaChart.getChart().getName(), megaChart.getxAxisTitle(), megaChart.getyAxisTitle(), dataset, PlotOrientation.VERTICAL, true, false, false);
    }
