...
import com.fbdblog.dao.hibernate.eventlisteners.RegerPostLoadEventListener;
import com.fbdblog.dao.hibernate.eventlisteners.RegerPreInsertEventListener;
import com.fbdblog.dao.hibernate.eventlisteners.RegerPreDeleteEventListener;
import com.fbdblog.dao.hibernate.eventlisteners.RegerPreUpdateEventListener;
        ...
        if (ApplicationStartup.getIswabapprooddirdiscovered()){
            if (InstanceProperties.haveValidConfig()){
                try {
                    ...
                    //conf.addPackage("com.fbdblog.dao.hibernate");
