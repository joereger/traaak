...
public class JbossTreeCacheAOPProvider implements CacheProvider {
    ...
    private static void setupCache(){
        Logger logger = Logger.getLogger("com.fbdblog.cache.providers.jboss.JbossTreeCacheAOPProvider");
        try{
    ...
    public String getCacheStatsAsHtml() {
        ...
        mb.append(com.fbdblog.cache.providers.jboss.CacheDumper.getHtml("/", 5));
        String[] keys = getKeys("");
