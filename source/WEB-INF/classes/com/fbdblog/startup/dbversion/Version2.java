...
public class Version2 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("DELETE FROM questionconfig WHERE name='usedisplayoverride'");
        //-----------------------------------
        //-----------------------------------
        ...
        //-----------------------------------
        //-----------------------------------
        int counte2 = Db.RunSQLUpdate("DELETE FROM questionconfig WHERE name='valuelabel'");
        //-----------------------------------
        //-----------------------------------
        
        //-----------------------------------
        //-----------------------------------
        int counte2asd = Db.RunSQLUpdate("DELETE FROM questionconfig WHERE name='displayoverridelabel'");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int counte2ss = Db.RunSQLUpdate("DELETE FROM questionconfig WHERE name='displayoverrides'");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int counte2f = Db.RunSQLUpdate("DELETE FROM questionuserconfig WHERE name='displayoverrides'");
        //-----------------------------------
        //-----------------------------------
